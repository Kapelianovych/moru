...
type _Event<T extends Element, E extends Event = Event> = E & {
  readonly target: Element;
  readonly currentTarget: T;
};

type EventAttributesMapOf<T extends globalThis.Element> = {
...
declare global {
  namespace JSX {
    ...
    type EventOf<E extends globalThis.Element, Name> = E extends HTMLElement
      ? _Event<E, HTMLElementEventMap[Cast<Name, keyof HTMLElementEventMap>]>
      : E extends SVGElement
      ? _Event<E, SVGElementEventMap[Cast<Name, keyof SVGElementEventMap>]>
      : _Event<E, Event>;

    type ElementOf<T extends keyof RegularElementsMap> =
    ...
    type AttributesOf<T extends keyof RegularElementsMap> = WithRef<
      AriaAttributes &
        CommonAttributes &
        RegularElementsMap[T] &
        EventAttributesMapOf<ElementOf<T>>,
      ElementOf<T>
    >;
    ...
    type IntrinsicElements = {
      readonly [K in keyof RegularElementsMap]: Partial<AttributesOf<K>>;
    };
  }
}
...
export const isHydrationEnabled: boolean;

/**
 * It is available in both *browser* and *server* environments.
 ...
 */
export function hydrate(element: JSX.Element, root?: Node): void;
